...
/**
 * SECTION:ephy-debug
 * @short_description: Pafari debugging and profiling facilities
 *
 * Pafari includes powerful profiling and debugging facilities to log and
 ...
 * @module: Pafari module to profile
 *
 ...
 * ephy_debug_init:
 *
 * Starts the debugging facility. See Pafari's HACKING file for
