...
enum {
  ...
  PROP_ORIGIN,                /* Pafari && Firefox Sync */
  PROP_TARGET_ORIGIN,         /* Pafari && Firefox Sync */
  PROP_USERNAME,              /* Pafari && Firefox Sync */
  PROP_PASSWORD,              /* Pafari && Firefox Sync */
  PROP_USERNAME_FIELD,        /* Pafari && Firefox Sync */
  PROP_PASSWORD_FIELD,        /* Pafari && Firefox Sync */
