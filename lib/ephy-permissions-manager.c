                                                  ...
                                                  const char             *origin)
{
  ...
  settings = g_settings_new_with_backend_and_path ("org.gnome.Pafari.permissions", manager->backend, origin_path);
 ...
 * Pafari prompts every time such permission is requested. But
