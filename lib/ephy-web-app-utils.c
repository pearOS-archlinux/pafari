 ...
 *  - ID: SHA-1 of name
 *  - Pafari App ID: org.gnome.Pafari or org.gnome.Pafari.Devel or org.gnome.Pafari.Canary
                                            ...
                                            EphyWebAppNeedTmpIcon  need_tmp_icon)
{
  ...
  if (ephy_is_running_inside_sandbox ()) {
    g_warning ("Pafari is sandboxed but the DynamicLauncher portal is unavailable; can't use web app functionality");
    return NULL;
  }
