...
**pafari** is the codename of Pafari, the web browser designed for the
...
Pafari has a comprehensive help system.  Run the browser
and select ``Help`` from the menu.

AUTHOR
------

Pafari has been developed by Marco Pesenti Gritti (in memoriam),
