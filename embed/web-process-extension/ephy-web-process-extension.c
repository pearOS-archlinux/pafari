                                               ...
                                               EphyWebProcessExtension *extension)
{
  ...
  {
    const char *page_uri;
    page_uri = webkit_web_page_get_uri (page);
    if (page_uri && (g_strcmp0 (page_uri, "ephy-about:overview") == 0 ||
                     g_strcmp0 (page_uri, "about:overview") == 0)) {
...

{
  ...
  /* Private script world, used by Pafari on normal web pages. */
