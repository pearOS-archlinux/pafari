                     ...
                     GTask                  *task)
{
  ...
  /* FIXME: Pafari should use webkit_web_view_try_close() and this should wait until after that. */
                                     ...
                                     GTask                  *task)
{
  ...
  g_warning ("%s(): '%s' not implemented by Pafari!", __FUNCTION__, method_name);
