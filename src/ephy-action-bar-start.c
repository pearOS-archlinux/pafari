...
ephy_action_bar_start_constructed (GObject *object)
{
  ...
  if (is_desktop_pantheon ()) {
    gtk_button_set_icon_name (GTK_BUTTON (action_bar_start->bookmarks_button),
                              "user-bookmarks");
  }
...
void
ephy_action_bar_start_set_show_bookmarks_button (EphyActionBarStart *action_bar_start,
                                                  gboolean            show)
{
  gtk_widget_set_visible (action_bar_start->bookmarks_button, show);
}
