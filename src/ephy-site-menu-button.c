...
struct _EphySiteMenuButton {
  ...
  GtkWidget *svg; /* GtkSvg not available in GTK4 4.20, using GtkWidget for now */
...
ephy_site_menu_button_init (EphySiteMenuButton *self)
{
  ...
  /* SVG animations not available in GTK4 4.20 */
...
ephy_site_menu_button_set_state (EphySiteMenuButton *self,
                                 unsigned int        state)
{
  /* SVG state changes not available in GTK4 4.20 */
