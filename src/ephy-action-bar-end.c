                          ...
                          EphyActionBarEnd *action_bar_end)
{
  ...
  if (widget == action_bar_end->new_tab_button)
...
static void
update_new_tab_button_visibility (EphyActionBarEnd *action_bar_end)
{
  EphyEmbedShell *embed_shell;

  embed_shell = ephy_embed_shell_get_default ();

  gtk_widget_set_visible (action_bar_end->new_tab_button,
...
ephy_action_bar_end_init (EphyActionBarEnd *action_bar_end)
{
  ...
  /* New Tab Button */
  update_new_tab_button_visibility (action_bar_end);
...
GtkWidget *
ephy_action_bar_end_get_page_menu_button (EphyActionBarEnd *action_bar_end)
{
  return action_bar_end->page_menu_button;
}
