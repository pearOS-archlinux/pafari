                  ...
                  gpointer      user_data)
{
  ...
  description = g_strdup_printf (ngettext ("Pafari prevented %u tracker from following you across websites", "Pafari prevented %u trackers from following you across websites", length), length);
